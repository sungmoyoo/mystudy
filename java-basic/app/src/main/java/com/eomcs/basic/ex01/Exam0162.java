...
public class Exam0162 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(classInfo.getName()); //[Ljava.lang.String; -> String 레퍼런스 배열
    ...
    System.out.println(new int[10].getClass().getName()); //[J
    System.out.println(new long[10].getClass().getName()); //[J
    System.out.println(new float[10].getClass().getName()); //[J
    System.out.println(new double[10].getClass().getName()); //[J
    System.out.println(new boolean[10].getClass().getName()); //[J
