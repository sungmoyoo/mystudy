...
public class Exam620 {
  public static void main(String[] args) {
    ...
    Worker1 w1 = new Worker1("홍길동.play1() 호출", job1);
    Worker2 w2 = new Worker2("임꺽정.play2() 호출", job1);
    Worker3 w3 = new Worker3("기모찌.play3() 호출", job2);
    Worker4 w4 = new Worker4("앙기모.play1() 호출", job1);
    w1.start();
    w2.start();
    w3.start();
    w4.start();
